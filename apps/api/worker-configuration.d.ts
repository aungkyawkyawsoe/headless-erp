/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d5266f14e089d4e9d0420235f022381)
// Runtime types generated with workerd@1.20260828.1 2026-07-31 nodejs_compat
interface __BaseEnv_Env {
	...
	JWT_SECRET: string;
	IS_DEV: string;
	RATE_LIMIT_DO: string;
	DOMAIN_MODULES: string;
	TELEGRAM_DIRECTORY_COLLECTION: string;
	TELEGRAM_DIRECTORY_FIELD: string;
	RATE_LIMIT: DurableObjectNamespace<import("./src/index").GlobalRateLimitStore>;
	SCHEDULER: DurableObjectNamespace<import("./src/index").SchedulerDO>;
	LOCK: DurableObjectNamespace<import("./src/index").LockDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GlobalRateLimitStore" | "SchedulerDO" | "LockDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TABLE_PREFIX" | "BACKUP_ENABLED" | "AI_PROVIDER" | "ANALYTICS_ENABLED" | "BACKUP_RETENTION_DAYS" | "ENABLE_R2_LAKE" | "R2_ACCOUNT_ID" | "R2_BUCKET" | "EVENT_QUEUE_NAME" | "ADMIN_USERNAME" | "ADMIN_PASSWORD" | "ADMIN_NAME" | "JWT_SECRET" | "IS_DEV" | "RATE_LIMIT_DO" | "DOMAIN_MODULES" | "TELEGRAM_DIRECTORY_COLLECTION" | "TELEGRAM_DIRECTORY_FIELD">> {}
}
