...
function ToastViewport({ className, ...props }: ToastPrimitive.Viewport.Props) {
	return (
		<ToastPrimitive.Viewport
			...
			// Clear the device + Telegram bottom chrome (0 in a plain browser) — the
			// ONE shared clearance token, so this matches every other bottom surface.
