...
function useMessageScrollerCommands({
	...
	const setAutoScrolling = React.useCallback(
		...
		[commitScrollState, autoscrollingRef, autoscrollingTimeoutRef],
	);
	...
	const scrollToStart = React.useCallback(
		...
		[scheduleVisibilitySync, scrollToPosition, setTailSpacerHeight, modeRef, streamingTurnRef, viewportRef],
	);
	...
	const scrollToEnd = React.useCallback(
		...
		[scheduleVisibilitySync, scrollToPosition, setTailSpacerHeight, autoScrollRef, modeRef, streamingTurnRef, viewportRef],
	);
	...
	}, [scrollToElement, modeRef, streamingTurnRef]);
	...
	const scrollToMessage = React.useCallback(
		...
		[scrollToElement, defaultScrollPositionAppliedRef, itemCountRef, messageElementsRef, pendingScrollToMessageRef],
	);
	...
	const flushPendingScrollToMessage = React.useCallback(() => {
		...
		return true;
	}, [scrollToElement, defaultScrollPositionAppliedRef, messageElementsRef, pendingScrollToMessageRef]);
