...
function MessageScrollerViewport({
	...
	const { handleResize, preserveScrollOnPrependRef, setViewportElement, syncAfterScroll, userScrollIntent, viewportRef } =
...
function MessageScrollerItem({ messageId, ref, scrollAnchor = false, ...props }: MessageScrollerItemProps) {
	...
	return <div ref={setItemRef} data-message-id={messageId} data-scroll-anchor={scrollAnchor ? 'true' : 'false'} {...props} />;
}
...
function MessageScrollerButton({
	...
	return useRender({
		...
		props: mergeProps<'button'>(
			// mergeProps may receive a consumer-supplied ref and forwards it to the
			// rendered element via createElement, which is ref-safe.
...
const MessageScrollerNamespace = {
...
export {
	MessageScrollerNamespace as MessageScroller,
