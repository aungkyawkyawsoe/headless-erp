...
function InputOTP({
	...
	return (
		<OTPInput
			data-slot="input-otp"
			containerClassName={cn('cn-input-otp flex items-center font-medium has-disabled:opacity-50', containerClassName)}
			spellCheck={false}
...
function InputOTPGroup({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			...
			className={cn(
				'flex items-center rounded-sm has-aria-invalid:border-destructive has-aria-invalid:ring-2 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40',
				className,
			)}
			{...props}
		/>
