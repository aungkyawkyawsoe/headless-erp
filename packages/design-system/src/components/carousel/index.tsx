...
function Carousel({
	...
	React.useEffect(() => {
		...
		// Sync the initial scroll state after the carousel has painted, then keep
		// it in sync through embla's events. The initial call is deferred so we
		// don't set state synchronously within the effect body.
